			...
			<div className="max-w-screen-xl w-full mx-auto px-3">
				<div className="login-area py-10 px-20 shadow-2xl w-full flex gap-12 justify-between items-center">
					<div className="login-left flex-1">
						<img className="w-full object-contain" src={authImg} alt="" />
					</div>
						...
						<form onSubmit={handelLogin}>
							<div className="form-area">
								...
								<div className="single-form relative">
									...
									<label className="captcha border-slate-300 border block" htmlFor=""><LoadCanvasTemplate /></label>
									<input className="w-full border-slate-300 border block text-slate-800 text-sm p-2 rounded-md bg-white" type="text" onChange={handleValidateCaptcha} />
									{
								...
								<div className="single-form">
									<button className="log-btn w-full bg-[#D1A054B2] disabled:bg-gray-100 text-white py-3 text-center rounded-lg font-bold text-xl" type="submit" disabled={disable}>Sign In</button>
								</div>
							</div>
						</form>
					</div>
